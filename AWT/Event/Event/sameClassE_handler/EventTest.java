package Event.sameClassE_handler;
...
public class EventTest implements ActionListener {
	...
	public void startFrame() {
		btn1.addActionListener(this); //리스너를 붙여주는 코드
	...
	public void actionPerformed(ActionEvent e) { // e가 이벤트 객체
		if (e.getActionCommand().equals("Button1")) { // equals: 문자열비교, 객체비교
